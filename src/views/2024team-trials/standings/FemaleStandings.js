...
const FemaleStandings = () => {
    ...
    const sortedFemaleStandings = sortStandings(athleteData).filter((athlete) => athlete.gender === 'Female');

    const aGroup = sortedFemaleStandings.filter((athlete) => athlete.group === 'A');
    const bGroup = sortedFemaleStandings.filter((athlete) => athlete.group === 'B');
    const cGroup = sortedFemaleStandings.filter((athlete) => athlete.group === 'C');
...
const AGroupStandingsTable = ({ standings }) => {
    return (
        <CCard className="mb-4">
            <CCardHeader>
                <strong>Live Standings</strong> - Female | A Group
            </CCardHeader>
            <CCardBody>
...
const BGroupStandingsTable = ({ standings }) => {
    return (
        <CCard className="mb-4">
            <CCardHeader>
                <strong>Live Standings</strong> - Female | B Group
            </CCardHeader>
            <CCardBody>
                <CTable striped hover responsive>
                    <CTableHead>
...
const CGroupStandingsTable = ({ standings }) => {
    return (
        <CCard className="mb-4">
            <CCardHeader>
                <strong>Live Standings</strong> - Female | C Group
            </CCardHeader>
            <CCardBody>
                <CTable striped hover responsive>
                    <CTableHead>
