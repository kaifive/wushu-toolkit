            ...
            <CRow>
                <CCol xs={12}>
                    <CCard className="mb-4">
                        <CCardHeader>
                            <strong>{athleteInfo.athleteName} Scorecard</strong> | {eventInfo.name}
                        </CCardHeader>
                        <CCardBody>
                            <CContainer>
                                <CRow className="justify-content-center align-items-center text-center">
                                    <CCol xs="12" md="2" style={{ minWidth: 130 }}>
                                        <JudgeGroupCard label="A SCORE" value={parseFloat(eventInfo?.a ?? 0)} />
                                    </CCol>
                                    <CCol xs="12" md="10">
                                        <DeductionCodes codes={eventInfo?.deductions ?? []} />
                                    </CCol>
                                </CRow>

                                <CRow className="justify-content-center align-items-center text-center">
                                    <CCol xs="12" md="2" style={{ minWidth: 130 }}>
                                        <JudgeGroupCard label="B SCORE" value={parseFloat(eventInfo?.b ?? 0)} />
                                    </CCol>
                                    <CCol xs="12" md="10">
                                        <BJudgeScores scores={eventInfo?.bScores ?? []} booleans={eventInfo?.b?.isNotDropped ?? []} />
                                    </CCol>
                                </CRow>
